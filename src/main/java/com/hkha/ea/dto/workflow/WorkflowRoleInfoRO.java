...
public class WorkflowRoleInfoRO {
	...
	private String employeeNumROHO;
	
	private String employeeNameROHO;
	...
	public String getEmployeeNumROHO() {
		return employeeNumROHO;
	}

	public void setEmployeeNumROHO(String employeeNumROHO) {
		this.employeeNumROHO = employeeNumROHO;
	}

	public String getEmployeeNameROHO() {
		return employeeNameROHO;
	}

	public void setEmployeeNameROHO(String employeeNameROHO) {
		this.employeeNameROHO = employeeNameROHO;
	}	
