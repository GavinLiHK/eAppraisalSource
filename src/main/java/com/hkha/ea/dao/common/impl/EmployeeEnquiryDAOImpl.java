...
//	private Log log = LogFactory.getLog(this.getClass());
	private Logger log = Logger.getLogger(EmployeeEnquiryDAOImpl.class.getName());
	//End 20231201 Write log in catalina.out
	
	//20240821 Name Presentation
	private String fullNamePattern = " initcap(per_all_people_f.title) || ' ' || upper(per_all_people_f.last_name) || ' ' || initcap(per_all_people_f.first_name) || decode(per_all_people_f.PRE_NAME_ADJUNCT, null, '', (' ' || initcap(lower(per_all_people_f.PRE_NAME_ADJUNCT)))) || decode(per_all_people_f.suffix, null, '', (', ' || per_all_people_f.suffix)) employeeFullName ";
...
//					.append("per_all_people_f.LAST_NAME lastName, per_all_people_f.FIRST_NAME firstName, per_all_people_f.full_name employeeFullName  ")
					.append("per_all_people_f.LAST_NAME lastName, per_all_people_f.FIRST_NAME firstName, ")
...
//						.append("per_all_people_f.LAST_NAME lastName, per_all_people_f.FIRST_NAME firstName, per_all_people_f.full_name employeeFullName  ")
			...
			MapSqlParameterSource paramSource = new MapSqlParameterSource();
			//20220705 prevent empty employee num edit by pccw
			if (Util.isEmptyString(employeeNum)) {
				employeeNum = "xx";
			}			
...
//			mainCriteria.append("select per_all_people_f.email_address emailAddress, per_all_people_f.full_name employeeFullName ");
			mainCriteria.append("select per_all_people_f.email_address emailAddress, ");
			mainCriteria.append(fullNamePattern);
			//End 20240821 Name Presentation
...
//	       	criteria.append("select papf.full_name employeeFullName, papf.employee_number employeeNum ");
	       	criteria.append("select papf.employee_number employeeNum, ");
