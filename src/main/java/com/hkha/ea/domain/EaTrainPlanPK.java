...
//@Embeddable  
public class EaTrainPlanPK implements Serializable{

	private static final long serialVersionUID = -1467426010532325054L;
    ...
    public boolean equals(Object obj) { 
        if(obj instanceof EaCoreCompetencyPK){ 
        	EaTrainPlanPK pk=(EaTrainPlanPK)obj; 
