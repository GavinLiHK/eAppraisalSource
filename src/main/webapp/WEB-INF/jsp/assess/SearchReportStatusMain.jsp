...
<body>
<form:form name="pageForm" modelAttribute="searchFinalReportDto" action="${ctx}/assess/searchRptStatusMain.do" method="post">
	    ...
	    <table width="100%" border="0" cellpadding="5" cellspacing="0">
	      <tr>
	        <td height="50" valign="bottom" class="PageHeadingFont">
	          Report Status Maintenance > Search Report
	        </td>
	      </tr>
	      <tr>
	        <td>
				 ...
				 <!-- portlet body -->
					...
					<tr height="100%">
					  ...
					  <table width="100%"  border="0" cellpadding="0">
						...
						<tr>
						  <td>Batch Name</td> 
						  <td><form:input type="text" path="batchName" classname="editableinputfield" size="20"  maxlength="40"/></td>
					    </tr>
						<!-- #2 Rank-->
						<tr>
						  <td>Rank</td> 
						...
						<tr>
						  ...
						  <td><form:input type="text" path="employeeNumber" classname="editableinputfield" size="20"  maxlength="40"/></td>
						</tr>
						<!-- #5 Employee Name-->
						<tr>
						  <td width="20%">Employee Name</td> 	 
						  <td><form:input type="text" path="employeeName" classname="editableinputfield" size="20"  maxlength="40"/></td>
						  
					    </tr>
						<!-- #6 Appraisal start date-->
						<tr>
      						<td width="28%">Commence Date Start Period *</td>
      						<td><common:commonDate id="commenceStartDate" name="commenceStartDate" /></td>
   						</tr>
						<!-- #7 Appraisal end date-->
						<tr>
      						<td width="28%">Commence Date End Period *</td>
     						<td><common:commonDate id="commenceEndDate" name="commenceEndDate" /></td>
    					</tr>
					  </table>
					</td>
				</tr>
